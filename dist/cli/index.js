    ...
    async start() {
        try {
            ...
            if (this.options[0] === undefined) {
                // Menu
                console.log("Welcome To Task Tracker CLI by @valentinlibonati33@gmail.com");
                console.log("Task tracker is a project used to track and manage your tasks.\n");
                ...
                console.log(`list in-progress             List only the Tasks in Progress`);
